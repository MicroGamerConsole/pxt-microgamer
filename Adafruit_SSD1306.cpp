...
#define SSD1306_VERTICAL_FLIPPED 0xC0
#define SDD1306_HORIZ_FLIPPED 0xA0
...
void Adafruit_SSD1306::begin(uint8_t vccstate)
{
    ...
    //  The Micro:Gamer display is upside-down
    command(SSD1306_VERTICAL_FLIPPED);
    command(SDD1306_HORIZ_FLIPPED);
